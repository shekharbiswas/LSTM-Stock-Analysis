Combining additional data with historical stock prices can significantly improve the performance of a stock price prediction model. Here are some types of data one can combine:
